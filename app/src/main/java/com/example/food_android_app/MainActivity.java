    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToBasket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("basketItems",(ArrayList<String>) basketContainer);
                startActivity(intent);
            }
        });

        ArrayList<RecommendedContainer> container = new ArrayList<>();
        container.add(new RecommendedContainer("https://tmbidigitalassetsazure.blob.core.windows.net/rms3-prod/attachments/37/1200x1200/Prosciutto-Egg-Panini_EXPS_CHMZ19_40992_E10_30_7b.jpg","Egg Sandwich","62eb14eca4ee7f69ce86fbaf"));
        ...
        container.add(new RecommendedContainer("https://newsghana.com.gh/wp-content/uploads/2022/06/Gari-and-Beans.jpg","Beans with plantain","62eb1236a4ee7f69ce86fb9b"));
